...
const btns = document.querySelectorAll(".ancor");
...
btns.forEach(function (hrefs) {
	hrefs.addEventListener('click', function onClick(e) {
		console.log(e.currentTarget.parentElement);
		const flexd = e.currentTarget.parentElement.parentElement;
	
		flexd.classList.toggle("show-flex");
		});
})
